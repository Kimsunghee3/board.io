...
//     for(var i = 0; i < slides.length; i++) {  //배열을 처음부터 끝까지 반복
...
// function nextSlide() {
//     if(current < slides.length -1) current += 1; //current값이 2보다 작으면 이전 위치로
//     else current = 0;
//         showSlides(current);
// }

//버튼을 클릭하지 않고 이미지를 자동전환 하는 방법
var current = 0;
showSlides();
